 ...
 */
export declare function render(meta: any, data: Object, resolvedPath: IValuePath): any;
/**
 ...
 * @returns {string} rendered string.
 */
export declare function resolveAndRender(meta: any, data: Object, path: IValuePath): any;
