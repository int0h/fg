...
import renderTpl from '../tplRender.ts';
import * as gapClassMgr from './gapClassMgr.ts';
import {IEventEmitter} from '../eventEmitter.ts';
import EventEmitter from '../eventEmitter.ts';
import {Gap} from './gapClassMgr.ts';
import * as utils from '../utils.ts';
import GapStorage from './GapStorage.ts';
...
export class FgInstanceBase{ 
	...
	renderTpl(tpl, parent, data, meta){
