import {IDataQueryObj, IDataPath} from './common/valueMgr';
import {prefixLines} from './server/serverUtils';
...
export default class DataDispatcher {
    ...
    genTransformer(): string {
        return `function transform(__utils, __rawData){return ${this.genTransformerBody()}}`;
    };
