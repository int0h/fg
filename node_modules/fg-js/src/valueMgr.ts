...
export class DataQuery {
	...
	render(data: Object, meta: IRenderMeta): string{
		...
		if (
			...
			throw new Error("Cannot render: [" + this.path.join('.') + "]");
		};
	...
	update(oldData: Object, newData: Object, meta: IRenderMeta): string | null {
		//remove: ugly
		console.warn('delete me / refactor');
		const oldValue = this.render(oldData, meta);
		const newValue = this.render(newData, meta);
		if (oldData === newValue){
			return null;
		};
		return newValue;
